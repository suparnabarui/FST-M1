...
public class Activity6 {
	...
	public void volume75Test() {
	    ...
	    Dimension rectangle = driver.manage().window().getSize();

	    // Calculate the start and end points
	    Point start = new Point((int)(rectangle.getWidth() * 0.5), (int)(rectangle.getHeight() * .77));
	    Point end = new Point((int)(rectangle.getWidth() * 0.67), (int)(rectangle.getHeight() * .77));
